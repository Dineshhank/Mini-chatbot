...
class MainActivity : AppCompatActivity() {
    ...
    private val botList = listOf("Medic-bot", "Medic-bot")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        customBotMessage("Hello! I'm an automatic symptom checker and will guide you through a simple interview, and you are? ")
    }
